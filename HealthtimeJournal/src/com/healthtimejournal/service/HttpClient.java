...
public class HttpClient {
	...
	//Upload URL
	private static final String UPLOAD_IMAGE = "http://192.168.43.185/healthtime/Test/upload.php";
	...
	private static final String EVENT_URL = "http://192.168.43.185/healthtime/Test/add_event.php";
	...
	private static final String EDIT_PARENT_PHOTO_URL = "http://192.168.43.185/healthtime/Test/edit_parent_photo.php";
	private static final String EDIT_FAMILY_URL = "http://192.168.43.185/healthtime/Test/edit_family.php";
	...
	private static final String RETRIEVE_GALLERY_BY_PARENT_URL = "http://192.168.43.185/healthtime/Test/retrieve_gallery_by_parent.php";
	private static final String RETRIEVE_GALLERY_BY_POST_URL = "http://192.168.43.185/healthtime/Test/retrieve_gallery_by_post.php";
	private static final String RETRIEVE_GALLERY_BY_CHILD_URL = "http://192.168.43.185/healthtime/Test/retrieve_gallery_by_child.php";
	private static final String RETRIEVE_GALLERY_LAST_UPLOAD_URL = "http://192.168.43.185/healthtime/Test/retrieve_gallery_last_upload.php";
	private static final String RETRIEVE_ALL_PARENT_URL = "http://192.168.43.185/healthtime/Test/retrieve_all_parent.php";
	private static final String RETRIEVE_ALL_CHILD_URL = "http://192.168.43.185/healthtime/Test/retrieve_all_child.php";
	private static final String RETRIEVE_ALL_DOCTOR_URL = "http://192.168.43.185/healthtime/Test/retrieve_all_doctor.php";
	private static final String RETRIEVE_SHARING_BY_CHILD_URL = "http://192.168.43.185/healthtime/Test/retrieve_sharing_by_child.php";
	private static final String RETRIEVE_NON_SHARED_PARENT_CHILD_URL = "http://192.168.43.185/healthtime/Test/retrieve_non_shared_parent_child.php";
	private static final String RETRIEVE_ALL_EVENT_URL = "http://192.168.43.185/healthtime/Test/retrieve_all_event.php";
	private static final String RETRIEVE_ALL_POST_BY_EVENT_URL = "http://192.168.43.185/healthtime/Test/retrieve_all_post_by_event.php";
	private static final String GET_LAST_URL = "http://192.168.43.185/healthtime/Test/retrieve_last_file_from_post.php";
	private static final String IMAGE_URL = "http://192.168.43.185/healthtime/Test/retrieve_picture.php";
	...
	public byte[] retrieve_image(int id){
		HttpResponseClient client = new HttpResponseClient();
		
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("id", String.valueOf(id)));
		
		return client.getImage(IMAGE_URL, "GET", params);
	}
	...
	public String retrieve_last_file_from_post(int id){
		HttpResponseClient client = new HttpResponseClient();
		
		List<NameValuePair> params = new ArrayList<NameValuePair>();
		params.add(new BasicNameValuePair("id", String.valueOf(id)));
		
		return client.makeHttpRequest(GET_LAST_URL, "GET", params);
	}
