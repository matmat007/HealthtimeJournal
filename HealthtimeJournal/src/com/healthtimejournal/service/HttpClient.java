...
public class HttpClient {
	...
	private static String REGISTER_URL = "http://172.16.3.127/healthtime/Test/add_parent.php";
	private static String LOGIN_URL = "http://172.16.3.127/healthtime/Test/login.php";
	
	//Upload URL
	private static final String UPLOAD_IMAGE = "http://172.16.3.127/healthtime/Test/upload.php";
	
	//Add Php Urls
	private static final String POST_URL = "http://172.16.3.127/healthtime/Test/add_post.php";
	private static final String ADD_SHARING_DOCTOR_URL = "http://172.16.3.127/healthtime/Test/add_sharing_doctor.php";
	private static final String ADD_DOCTOR_URL = "http://172.16.3.127/healthtime/Test/add_doctor.php";
	private static final String ADD_COMMENT_URL = "http://172.16.3.127/healthtime/Test/add_comment.php";
	private static final String ADD_MEDICAL_HISTORY_URL = "http://172.16.3.127/healthtime/Test/add_medical_history.php";
	private static final String ADD_FAMILY_URL = "http://172.16.3.127/healthtime/Test/add_family.php";
	...
	private static final String DELETE_POST_URL = "http://172.16.3.127/healthtime/Test/delete_post.php";
	...
	private static final String EDIT_DOCTOR_URL = "http://172.16.3.127/healthtime/Test/edit_doctor.php";
	private static final String EDIT_MEDICAL_HISTORY_URL = "http://172.16.3.127/healthtime/Test/edit_medical_history.php";
	private static final String EDIT_DISEASE_URL = "http://172.16.3.127/healthtime/Test/edit_disease_dictionary.php";
	...
	private static final String RETRIEVE_DOCTOR_URL = "http://172.16.3.127/healthtime/Test/retrieve_doctor.php";
	private static final String RETRIEVE_DOCTOR_BY_PARENT_URL = "http://172.16.3.127/healthtime/Test/retrieve_doctor_by_parent.php";
	private static final String RETRIEVE_DOCTOR_BY_SEARCH_URL = "http://172.16.3.127/healthtime/Test/retrieve_doctor_by_search.php";
	private static final String RETRIEVE_POST_OF_PARENT_BY_CHILD_URL = "http://172.16.3.127/healthtime/Test/retrieve_all_all_post_of_parent_by_child.php";
	private static final String RETRIEVE_SHARED_TO_PARENT_ACCOUNTS_URL = "http://172.16.3.127/healthtime/Test/retrieve_shared_to_parent_accounts.php";
	private static final String RETRIEVE_PARENT_URL = "http://172.16.3.127/healthtime/Test/retrieve_parent.php";
	private static final String RETRIEVE_PARENT_BY_SEARCH_URL = "http://172.16.3.127/healthtime/Test/retrieve_parent_by_search.php";
	private static final String RETRIEVE_SHARED_BY_PARENT_ACCOUNTS_URL = "http://172.16.3.127/healthtime/Test/retrieve_shared_by_parent_accounts.php";
	private static final String RETRIEVE_MEDICAL_HISTORY_URL = "http://172.16.3.127/healthtime/Test/retrieve_parent_medical_history.php";
	private static final String RETRIEVE_SHARED_TO_DOCTOR_ACCOUNTS_URL = "http://172.16.3.127/healthtime/Test/retrieve_shared_to_doctor_accounts.php";
	private static final String RETRIEVE_FAMILY_URL = "http://172.16.3.127/healthtime/Test/retrieve_family.php";
	private static final String RETRIEVE_SHARED_FROM_FAMILY_CHILD_URL = "http://172.16.3.127/healthtime/Test/retrieve_shared_from_family_child.php";
	private static final String RETRIEVE_SHARED_TO_PARENT_CHILD_URL = "http://172.16.3.127/healthtime/Test/retrieve_shared_to_parent_child.php";
	private static final String RETRIEVE_DISEASE_URL = "http://172.16.3.127/healthtime/Test/retrieve_disease_dictionary.php";
	private static final String RETRIEVE_GALLERY_BY_PARENT_URL = "http://172.16.3.127/healthtime/Test/retrieve_gallery_by_parent.php";
	private static final String RETRIEVE_GALLERY_BY_POST_URL = "http://172.16.3.127/healthtime/Test/retrieve_gallery_by_post.php";
	private static final String RETRIEVE_GALLERY_BY_CHILD_URL = "http://172.16.3.127/healthtime/Test/retrieve_gallery_by_child.php";
	private static final String RETRIEVE_GALLERY_LAST_UPLOAD_URL = "http://172.16.3.127/healthtime/Test/retrieve_gallery_last_upload.php";
	private static final String RETRIEVE_ALL_PARENT_URL = "http://172.16.3.127/healthtime/Test/retrieve_all_parent.php";
	private static final String RETRIEVE_ALL_CHILD_URL = "http://172.16.3.127/healthtime/Test/retrieve_all_child.php";
	...
	public String retrieve_non_shared_parents_by_child(int id){
		HttpResponseClient client = new HttpResponseClient();
